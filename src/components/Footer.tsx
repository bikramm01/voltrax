      ...
      <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col md:flex-row md:gap-3 text-xs text-gray-600">
            <Link href="/#about" className="hover:text-green-600 transition py-1">
              About
            </Link>
            <Link href="/#contact" className="hover:text-green-600 transition py-1">
              Contact
            </Link>
            <Link href="/#products" className="hover:text-green-600 transition py-1">
              Products
            </Link>
            <Link href="/faq" className="hover:text-green-600 transition py-1">
              FAQ
            </Link>
            <Link href="/blog" className="hover:text-green-600 transition py-1">
              Blog
            </Link>
            <Link href="/privacy" className="hover:text-green-600 transition py-1">
              Privacy
            </Link>
            <Link href="/terms" className="hover:text-green-600 transition py-1">
              Terms
            </Link>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex gap-4">
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/voltrax.in"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:scale-110 transition-transform"
            >
            ...
            {/* YouTube */}
            <a
              href="https://www.youtube.com/@voltrax.in"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:scale-110 transition-transform"
            >
